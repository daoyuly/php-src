...
ZEND_VM_HELPER_EX(zend_binary_assign_op_obj_helper, VAR|UNUSED|CV, CONST|TMP|VAR|UNUSED|CV, int (*binary_op)(zval *result, zval *op1, zval *op2 TSRMLS_DC))
{
	...
	zval **object_ptr = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
	zval *object;
...
ZEND_VM_HELPER_EX(zend_binary_assign_op_helper, VAR|UNUSED|CV, CONST|TMP|VAR|UNUSED|CV, int (*binary_op)(zval *result, zval *op1, zval *op2 TSRMLS_DC))
{
	...
	switch (opline->extended_value) {
		...
		case ZEND_ASSIGN_DIM: {
				zval **container = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
				...
				if (OP1_TYPE == IS_VAR && UNEXPECTED(container == NULL)) {
					...
					var_ptr = _get_zval_ptr_ptr_var_unlock((opline+1)->op2.var, execute_data, &free_op_data2 TSRMLS_CC);
				}
			}
			break;
		default:
			value = GET_OP2_ZVAL_PTR(BP_VAR_R);
			var_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
			/* do nothing */
			break;
	}
...
ZEND_VM_HELPER_EX(zend_pre_incdec_property_helper, VAR|UNUSED|CV, CONST|TMP|VAR|CV, incdec_t incdec_op)
{
	...
	SAVE_OPLINE();
	object_ptr = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
...
ZEND_VM_HANDLER(84, ZEND_FETCH_DIM_W, VAR|CV, CONST|TMP|VAR|UNUSED|CV)
{
	...
	SAVE_OPLINE();
	container = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HANDLER(87, ZEND_FETCH_DIM_RW, VAR|CV, CONST|TMP|VAR|UNUSED|CV)
{
	...
	SAVE_OPLINE();
	container = GET_OP1_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
...
ZEND_VM_HANDLER(96, ZEND_FETCH_DIM_UNSET, VAR|CV, CONST|TMP|VAR|CV)
{
	...
	SAVE_OPLINE();
	container = GET_OP1_ZVAL_PTR_PTR(BP_VAR_UNSET, UNLOCK);
...
ZEND_VM_HANDLER(85, ZEND_FETCH_OBJ_W, VAR|UNUSED|CV, CONST|TMP|VAR|CV)
{
	...
	container = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
	if (OP1_TYPE == IS_VAR && UNEXPECTED(container == NULL)) {
		zend_error_noreturn(E_ERROR, "Cannot use string offset as an object");
	}
...
ZEND_VM_HANDLER(88, ZEND_FETCH_OBJ_RW, VAR|UNUSED|CV, CONST|TMP|VAR|CV)
{
	...
	SAVE_OPLINE();
	property = GET_OP2_ZVAL_PTR(BP_VAR_R);
	container = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_RW, UNLOCK);
...
ZEND_VM_HANDLER(97, ZEND_FETCH_OBJ_UNSET, VAR|UNUSED|CV, CONST|TMP|VAR|CV)
{
	...
	SAVE_OPLINE();
	container = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_UNSET, UNLOCK);
	property = GET_OP2_ZVAL_PTR(BP_VAR_R);
...
ZEND_VM_HANDLER(136, ZEND_ASSIGN_OBJ, VAR|UNUSED|CV, CONST|TMP|VAR|CV)
{
	...
	SAVE_OPLINE();
	object_ptr = GET_OP1_OBJ_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HANDLER(147, ZEND_ASSIGN_DIM, VAR|CV, CONST|TMP|VAR|UNUSED|CV)
{
	...
	SAVE_OPLINE();
	object_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
	...
	if (Z_TYPE_PP(object_ptr) == IS_OBJECT) {
		...
		value = get_zval_ptr((opline+1)->op1_type, &(opline+1)->op1, execute_data, &free_op_data1, BP_VAR_R);
		variable_ptr_ptr = _get_zval_ptr_ptr_var_unlock((opline+1)->op2.var, execute_data, &free_op_data2 TSRMLS_CC);
...
ZEND_VM_HANDLER(38, ZEND_ASSIGN, VAR|CV, CONST|TMP|VAR|CV)
{
	...
	SAVE_OPLINE();
	value = GET_OP2_ZVAL_PTR(BP_VAR_R, UNLOCK);
	variable_ptr_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HANDLER(39, ZEND_ASSIGN_REF, VAR|CV, VAR|CV)
{
	...
	SAVE_OPLINE();
	value_ptr_ptr = GET_OP2_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HANDLER(111, ZEND_RETURN_BY_REF, CONST|TMP|VAR|CV, ANY)
{
	...
	do {
		...
		retval_ptr_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HELPER(zend_send_by_var_helper, VAR|CV, ANY)
{
	...
	zval *varptr;
	zend_free_op free_op1;
	varptr = GET_OP1_ZVAL_PTR(BP_VAR_R, UNLOCK);
	...
	FREE_OP1(UNLOCK);  /* for string offsets */
...
ZEND_VM_HANDLER(67, ZEND_SEND_REF, VAR|CV, ANY)
{
	...
	SAVE_OPLINE();
	varptr_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
...
ZEND_VM_HANDLER(72, ZEND_ADD_ARRAY_ELEMENT, CONST|TMP|VAR|CV, CONST|TMP|VAR|UNUSED|CV)
{
	...
	if ((OP1_TYPE == IS_VAR || OP1_TYPE == IS_CV) && opline->extended_value) {
		zval **expr_ptr_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
		...
		expr_ptr = GET_OP1_ZVAL_PTR(BP_VAR_R, UNLOCK);
...
ZEND_VM_HANDLER(21, ZEND_CAST, CONST|TMP|VAR|CV, ANY)
{
	...
	SAVE_OPLINE();
	expr = GET_OP1_ZVAL_PTR(BP_VAR_R, UNLOCK);
...
ZEND_VM_HANDLER(77, ZEND_FE_RESET, CONST|TMP|VAR|CV, ANY)
{
	...
	if ((OP1_TYPE == IS_CV || OP1_TYPE == IS_VAR) &&
		...
		array_ptr_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_R, UNLOCK);
		...
		array_ptr = GET_OP1_ZVAL_PTR(BP_VAR_R, UNLOCK);
	...
	if (OP1_TYPE != IS_UNUSED) {
		...
		if (EX(op_array)->fn_flags & ZEND_ACC_RETURN_REFERENCE) {
			...
			if (OP1_TYPE == IS_CONST || OP1_TYPE == IS_TMP_VAR) {
				...
				zval **value_ptr = GET_OP1_ZVAL_PTR_PTR(BP_VAR_W, UNLOCK);
			...
			zval *value = GET_OP1_ZVAL_PTR(BP_VAR_R, UNLOCK);
