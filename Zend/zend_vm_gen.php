...
$op1_free_op = array(
	...
	"VAR"    => "if (free_op1.var) {PZVAL_UNLOCK_FREE(free_op1.var);}",
	"CONST"  => "",
	"UNUSED" => "",
	"CV"     => "",
);
...
$op2_free_op = array(
	...
	"VAR"    => "if (free_op2.var) {PZVAL_UNLOCK_FREE(free_op2.var);}",
	"CONST"  => "",
	"UNUSED" => "",
	"CV"     => "",
);
...
$op1_free_op_var_ptr = array(
	"ANY"    => "if (free_op1.var) {PZVAL_UNLOCK_FREE(free_op1.var);}",
	"TMP"    => "",
	"VAR"    => "if (free_op1.var) {PZVAL_UNLOCK_FREE(free_op1.var);}",
	"CONST"  => "",
	"UNUSED" => "",
...
$op2_free_op_var_ptr = array(
	"ANY"    => "if (free_op2.var) {PZVAL_UNLOCK_FREE(free_op2.var);}",
	"TMP"    => "",
	"VAR"    => "if (free_op2.var) {PZVAL_UNLOCK_FREE(free_op2.var);}",
	"CONST"  => "",
	"UNUSED" => "",
